...
class User(AbstractUser, TimestampedModel):
    ...
    gender = models.CharField(
        max_length=10, choices=GENDER_CHOICES, default="", null=True
    )
...
class Doctor(TimestampedModel):
    ...
    speciality = models.CharField(
        max_length=20, choices=SPECIALITY_CHOICES, default="GENERAL"
    )
    status = models.CharField(max_length=8, choices=STATUS, default="ACTIVE")
...
class MedicsAppointment(TimestampedModel):
    ...
    category = models.CharField(
        max_length=20, choices=MEDICS_CATEFORY_CHOICES, default="MALARIA"
    )
    case_type = models.CharField(
        max_length=10, choices=CASE_TYPE_CHOICES, default=CASE_TYPE_CHOICES[0][0]
    )
    appointment_booked = models.BooleanField(default=False)
    appointment_session = models.CharField(
        max_length=20,
        choices=APPOINTEMENT_SESSION_CHOICES,
